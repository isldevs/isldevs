 ...
 */
package com.base.portfolio.office.model;
 ...
 */
@Entity
@Table(name = "office", uniqueConstraints = {@UniqueConstraint(name = "office_name_en_key", columnNames = "name_en"), @UniqueConstraint(name = "office_name_km_key", columnNames = "name_km"), @UniqueConstraint(name = "office_name_zh_key", columnNames = "name_zh")})
public class Office extends CustomAbstractAuditable {
