...
public class DistrictDataValidation {
  ...
  @Autowired
  public DistrictDataValidation(final JsonHelper jsonHelper, final ApiDataValidator validator) {
  ...
  public void create(String json) {
    ...
    final var postalCode =
        this.jsonHelper.extractString(DistrictConstants.POSTAL_CODE, jsonElement);
    validator
        .parameter(DistrictConstants.POSTAL_CODE, postalCode)
        .isString()
        .notEmpty()
        .maxLength(50);
    ...
    if (this.jsonHelper.parameterExists(DistrictConstants.COMMUNE, jsonElement)) {
      final var communes =
          this.jsonHelper.extractArrayAsObject(DistrictConstants.COMMUNE, jsonElement);
