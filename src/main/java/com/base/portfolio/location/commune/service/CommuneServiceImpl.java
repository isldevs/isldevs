...
public class CommuneServiceImpl implements CommuneService {
    ...
    public Map<String, Object> createCommune(JsonCommand command) {
        ...
        final var data = Commune.fromJson(district,
                                          command);
    ...
    public Page<CommuneDTO> listCommunes(Integer page,
        ...
        try {
            ...
            if (page != null && size != null) {
                ...
                List<CommuneDTO> content = jdbcTemplate.query(paginatedSql,
                                                              this::mapRow,
                                                              params.toArray());
                ...
                List<CommuneDTO> content = jdbcTemplate.query(sql,
                                                              this::mapRow,
                                                              params.toArray());
                Long total = jdbcTemplate.queryForObject(countSql,
                                                         Long.class,
    ...
    private CommuneDTO mapRow(ResultSet rs,
        ...
        try {
            villages = fromJsonAsList(rs.getString("villages"),
                                      VillageDTO[].class);
