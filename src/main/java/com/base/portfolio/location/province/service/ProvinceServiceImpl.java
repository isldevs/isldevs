...
public class ProvinceServiceImpl implements ProvinceService {
    ...
    public Page<ProvinceDTO> listProvinces(Integer page,
        ...
        try {
            ...
            if (page != null && size != null) {
                ...
                List<ProvinceDTO> content = jdbcTemplate.query(paginatedSql,
                                                               this::mapRow,
                                                               params.toArray());
                ...
                List<ProvinceDTO> content = jdbcTemplate.query(sql,
                                                               this::mapRow,
                                                               params.toArray());
                Long total = jdbcTemplate.queryForObject(countSql,
                                                         Long.class,
    ...
    private ProvinceDTO mapRow(ResultSet rs,
        ...
        try {
            districts = fromJsonAsList(rs.getString("districts"),
                                       DistrictDTO[].class);
