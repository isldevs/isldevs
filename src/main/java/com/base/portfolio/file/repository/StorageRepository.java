...
public class StorageRepository implements StorageUtils {
  ...
  public String writeFile(
    ...
    try {
      ...
      throw new ErrorException(
          HttpStatus.INTERNAL_SERVER_ERROR, "msg.internal.error", "Writing file failed", path);
    }
  }
  ...
  public String readBase64(Path path) {
    try {
      ...
      throw new ErrorException(
          HttpStatus.INTERNAL_SERVER_ERROR, "msg.internal.error", "Reading file failed", path);
    }
  }
  ...
  public void deleteFile(Path path) {
    try {
      ...
      throw new ErrorException(
          HttpStatus.INTERNAL_SERVER_ERROR, "msg.internal.error", "Deleting file failed", path);
    }
  }
}
