...
public interface FileService {
    ...
    Map<String, Object> fileURL(String entity,
                                Long entityId);

    @PreAuthorize("hasAnyAuthority('FULL_ACCESS', 'READ_FILE')")
    Map<String, Object> fileBase64(String entity,
                                   Long entityId);

    @PreAuthorize("hasAnyAuthority('FULL_ACCESS', 'READ_FILE')")
    Map<String, Object> fileByte(String entity,
                                 Long entityId);

    @PreAuthorize("hasAnyAuthority('FULL_ACCESS', 'READ_FILE')")
    Map<String, Object> fileInputStream(String entity,
                                        Long entityId);
