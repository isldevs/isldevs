...
public class FileServiceImpl implements FileService {
  ...
  public Map<String, Object> uploadFile(JsonCommand command) {
    ...
    try {
      ...
      File entityFile =
          this.repository.findByEntityAndEntityId(command.getEntityType(), command.getEntityId());
      if (entityFile == null) {
        entityFile =
            File.builder().entity(command.getEntityType()).entityId(command.getEntityId()).build();
      } else {
      ...
      throw new ErrorException(
          HttpStatus.INTERNAL_SERVER_ERROR, "msg.internal.error", "Error while uploading file");
    }
  }
  ...
  public Map<String, Object> fileURL(String entity, Long entityId) {
    ...
    if (file == null) throw new NotFoundException("msg.not.found", entity, entityId);
