...
public class FileController {
	...
	@Autowired
	public FileController(final JsonSerializerImpl<FileDTO> serializer, final FileService service,
	...
	public String uploadFile(@PathVariable("entity") final String entity, @PathVariable("entityId") final Long entityId,
			@RequestParam("file") final MultipartFile file) {

		FileUtils.isValidEntityName(entity);
		FileUtils.isValidateMimeType(file.getContentType());

		final var command = new FileCommandHandler().upload(entity, entityId).file(file).build();
	...
	public String deleteFile(@PathVariable("entity") final String entity,
		...
		FileUtils.isValidEntityName(entity);
		final var command = new FileCommandHandler().delete(entity, entityId).build();
	...
	public String fileURL(@PathVariable("entity") final String entity, @PathVariable("entityId") final Long entityId) {
		FileUtils.isValidEntityName(entity);
	...
	public String fileByte(@PathVariable("entity") final String entity, @PathVariable("entityId") final Long entityId) {
		FileUtils.isValidEntityName(entity);
