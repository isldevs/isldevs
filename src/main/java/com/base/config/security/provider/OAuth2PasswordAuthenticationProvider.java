  ...
  public Authentication authenticate(Authentication authentication) throws AuthenticationException {
    ...
    if (userAuthentication == null || !userAuthentication.isAuthenticated()) {
      throw new OAuth2AuthenticationException(
          new OAuth2Error(OAuth2ErrorCodes.INVALID_GRANT), "User authentication failed");
    }
    ...
    if (oAuth2Token == null) {
      throw new OAuth2AuthenticationException(
          new OAuth2Error(OAuth2ErrorCodes.SERVER_ERROR), "Access token generation failed");
    }
    var accessToken =
    ...
    return new OAuth2AccessTokenAuthenticationToken(
        registeredClient, userAuthentication, accessToken, refreshToken, additionalParameters);
  }
