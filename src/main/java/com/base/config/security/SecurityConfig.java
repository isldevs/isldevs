...
public class SecurityConfig {
  ...
  public RegisteredClient microserviceClient() {
    return RegisteredClient.withId(UUID.randomUUID().toString())
        ...
        .scope("api.write")
        .clientSettings(ClientSettings.builder().jwkSetUrl(issuerUri + "/oauth2/jwks").build())
        .tokenSettings(
            TokenSettings.builder()
                .accessTokenFormat(OAuth2TokenFormat.SELF_CONTAINED)
  ...
  public ClientRegistration githubClientRegistration() {
    if (config.getConfigValue("GITHUB_CLIENT_ID") != null
        && config.getConfigValue("GITHUB_CLIENT_SECRET") != null) {
  ...
  public ClientRegistration googleClientRegistration() {
    if (config.getConfigValue("GOOGLE_CLIENT_ID") != null
        && config.getConfigValue("GOOGLE_CLIENT_SECRET") != null) {
  ...
  public ClientRegistration facebookClientRegistration() {
    if (config.getConfigValue("FACEBOOK_CLIENT_ID") != null
        && config.getConfigValue("FACEBOOK_CLIENT_SECRET") != null) {
  ...
  public JwtBearerAuthenticationProvider jwtBearerAuthenticationProvider(
    ...
    return new JwtBearerAuthenticationProvider(
        jwtDecoder, registeredClientRepository, authorizationService, tokenGenerator);
  }
  ...
  public JwtAuthenticationProvider jwtAuthenticationProvider(
    ...
    return new JwtAuthenticationProvider(
        registeredClientRepository, new ClientAssertionJwtDecoderFactory(rsaKeyPairRepository));
  }
  ...
  public CorsConfigurationSource corsConfigurationSource() {
    ...
    configuration.setAllowedOrigins(
        List.of("https://127.0.0.1:8443", "http://127.0.0.1:8080", "http://127.0.0.1:3000"));
  ...
  public OAuth2AuthorizationService authorizationService(
    ...
    objectMapper.addMixIn(
        Class.forName("com.base.core.authentication.user.model.User"), User.class);
    objectMapper.addMixIn(
        Class.forName("org.hibernate.collection.spi.PersistentSet"), PersistentSet.class);
    objectMapper.addMixIn(Class.forName("java.util.HashSet"), HashSet.class);
    objectMapper.addMixIn(
        Class.forName("java.util.Collections$UnmodifiableSet"), Collections.class);
    objectMapper.addMixIn(
        Class.forName("java.util.ImmutableCollections$ListN"), ImmutableCollections.class);
  ...
  public WebClient rest(
      ClientRegistrationRepository clients, OAuth2AuthorizedClientRepository auth) {
