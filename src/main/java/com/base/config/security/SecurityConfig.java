...
public class SecurityConfig {
    ...
    public JwtBearerAuthenticationProvider jwtBearerAuthenticationProvider(JwtDecoder jwtDecoder,
        ...
        return new JwtBearerAuthenticationProvider(jwtDecoder,
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://127.0.0.1:8443",
                                                "http://127.0.0.1:8080",
                                                "http://127.0.0.1:3000"));
    ...
    public OAuth2AuthorizationService authorizationService(JdbcOperations jdbcOperations,
        ...
        objectMapper.addMixIn(Class.forName("com.base.core.authentication.user.model.User"),
                              User.class);
        objectMapper.addMixIn(Class.forName("org.hibernate.collection.spi.PersistentSet"),
                              PersistentSet.class);
        objectMapper.addMixIn(Class.forName("java.util.HashSet"),
                              HashSet.class);
        objectMapper.addMixIn(Class.forName("java.util.Collections$UnmodifiableSet"),
                              Collections.class);
        objectMapper.addMixIn(Class.forName("java.util.ImmutableCollections$ListN"),
    ...
    public WebClient rest(ClientRegistrationRepository clients,
        ...
        ServletOAuth2AuthorizedClientExchangeFilterFunction oauth2 = new ServletOAuth2AuthorizedClientExchangeFilterFunction(clients,
                                                                                                                             auth);
