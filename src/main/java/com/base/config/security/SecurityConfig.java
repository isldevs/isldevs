...
public class SecurityConfig {
	...
	@Autowired
	public SecurityConfig(final GlobalConfig config, final MessageSource messageSource,
	...
	public JwtBearerAuthenticationProvider jwtBearerAuthenticationProvider(JwtDecoder jwtDecoder,
		...
		return new JwtBearerAuthenticationProvider(jwtDecoder, registeredClientRepository, authorizationService,
				tokenGenerator);
	}
	...
	public JwtAuthenticationProvider jwtAuthenticationProvider(RegisteredClientRepository registeredClientRepository,
		...
		return new JwtAuthenticationProvider(registeredClientRepository,
				new ClientAssertionJwtDecoderFactory(rsaKeyPairRepository));
	}
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		configuration
			.setAllowedOrigins(List.of("https://127.0.0.1:8443", "http://127.0.0.1:8080", "http://127.0.0.1:3000"));
