...
public class AccessTokenResponseClient
  ...
  private MultiValueMap<String, String> createTokenRequestParameters(
      OAuth2AuthorizationCodeGrantRequest authorizationGrantRequest) {
    MultiValueMap<String, String> parameters = new LinkedMultiValueMap<>();
    parameters.add(
        OAuth2ParameterNames.GRANT_TYPE, authorizationGrantRequest.getGrantType().getValue());
    parameters.add(
    ...
    OAuth2AuthorizationRequest authorizationRequest =
        authorizationGrantRequest.getAuthorizationExchange().getAuthorizationRequest();
    String codeVerifier =
        (String) authorizationRequest.getAttribute(PkceParameterNames.CODE_VERIFIER);
  ...
  private OAuth2AccessTokenResponse extractTokenResponse(
      String responseBody, ClientRegistration clientRegistration) {
    try {
