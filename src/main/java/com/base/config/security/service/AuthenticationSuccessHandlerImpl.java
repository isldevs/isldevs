...
public class AuthenticationSuccessHandlerImpl implements AuthenticationSuccessHandler {
	...
	public AuthenticationSuccessHandlerImpl(final AuthenticationService authenticationService,
			final SessionRegistry sessionRegistry, final UserRepository userRepository,
	...
	private boolean isApiRequest(HttpServletRequest request) {
		...
		return acceptHeader.contains("application/json") || contentTypeHeader.contains("application/json")
