...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorData> handleAccessDeniedException(AuthorizationDeniedException ex, Locale locale) {
		...
		String localizedMessage = messageSource.getMessage("msg.access.denied", args != null ? args.toArray() : null,
				ex.getMessage(), locale);
		return buildResponseEntity(HttpStatus.FORBIDDEN, localizedMessage, ex.getMessage(),
	...
	public ResponseEntity<ErrorData> handleNotFoundException(NullPointerException ex, Locale locale) {
		...
		return buildResponseEntity(HttpStatus.INTERNAL_SERVER_ERROR, localizedMessage, ex.getMessage(),
				ex.getSuppressed());
	}
	...
	private ResponseEntity<ErrorData> buildResponseEntity(HttpStatus status, String message, String error,
			Object[] args) {
